...
public  class HaxeProtocol extends haxe.lang.HxObject
{
	...
	public    HaxeProtocol()
	{
		org.flashdevelop.cpp.debugger.HaxeProtocol.__hx_ctor_org_flashdevelop_cpp_debugger_HaxeProtocol(this);
	}
	
	
	public static   void __hx_ctor_org_flashdevelop_cpp_debugger_HaxeProtocol(org.flashdevelop.cpp.debugger.HaxeProtocol __temp_me29)
	{
		{
		}
	...
	{
		output.writeString(org.flashdevelop.cpp.debugger.HaxeProtocol.gServerIdentification);
	}
	
	
	public static   void readClientIdentification(haxe.io.Input input)
	{
		haxe.io.Bytes id = input.read(org.flashdevelop.cpp.debugger.HaxeProtocol.gClientIdentification.length());
		if ( ! (haxe.lang.Runtime.valEq(id.toString(), org.flashdevelop.cpp.debugger.HaxeProtocol.gClientIdentification)) ) 
		{
	...
	{
		haxe.io.Bytes id = input.read(org.flashdevelop.cpp.debugger.HaxeProtocol.gServerIdentification.length());
		if ( ! (haxe.lang.Runtime.valEq(id.toString(), org.flashdevelop.cpp.debugger.HaxeProtocol.gServerIdentification)) ) 
		{
	...
	public static   void writeCommand(haxe.io.Output output, org.flashdevelop.cpp.debugger.Command command)
	{
		org.flashdevelop.cpp.debugger.HaxeProtocol.writeDynamic(output, command);
	}
	
	
	public static   void writeMessage(haxe.io.Output output, org.flashdevelop.cpp.debugger.Message message)
	{
		org.flashdevelop.cpp.debugger.HaxeProtocol.writeDynamic(output, message);
	}
	
	
	public static   org.flashdevelop.cpp.debugger.Command readCommand(haxe.io.Input input)
	{
		java.lang.Object raw = org.flashdevelop.cpp.debugger.HaxeProtocol.readDynamic(input);
		try 
		{
			return ((org.flashdevelop.cpp.debugger.Command) (raw) );
		}
	...
	public static   org.flashdevelop.cpp.debugger.Message readMessage(haxe.io.Input input)
	{
		java.lang.Object raw = org.flashdevelop.cpp.debugger.HaxeProtocol.readDynamic(input);
		try 
		{
			return ((org.flashdevelop.cpp.debugger.Message) (raw) );
		}
	...
	{
		return new org.flashdevelop.cpp.debugger.HaxeProtocol(((haxe.lang.EmptyObject) (haxe.lang.EmptyObject.EMPTY) ));
	}
	
	
	public static   java.lang.Object __hx_create(haxe.root.Array arr)
	{
		return new org.flashdevelop.cpp.debugger.HaxeProtocol();
	}
